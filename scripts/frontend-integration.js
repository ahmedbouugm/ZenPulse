 ...
 * This file demonstrates how to integrate Zenpulse with a web frontend
 */

// For React/Vue/Angular applications
export class ZenpulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZenpulseClient(provider, contractAddress);
